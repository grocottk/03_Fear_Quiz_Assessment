...
class Start:
    def __init__(self, parent):
        ...
        self.check_questions_number_button = Button(self.start_buttons_frame, text="Check Questions Number", font="Arial 10", pady=5, padx=10, bg="pink",
        ...
        self.start_button = Button(self.start_buttons_frame, text="Start", font="Arial 10", pady=5, padx=10, bg="green", width=25,
